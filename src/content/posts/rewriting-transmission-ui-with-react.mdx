...
thumbnail: /img/posts/rewriting-transmission-ui-with-react/inject-store.png
---
...
![Inject stores to views](/img/posts/rewriting-transmission-ui-with-react/inject-store.png)
...
![Connection dialog with styles](/img/posts/rewriting-transmission-ui-with-react/connection-dialog-js.png)

Style `fileConnectionDialog/styles/index.css`:

![CSS code for Connection Dialog](/img/posts/rewriting-transmission-ui-with-react/connection-dialog-css.png)
...
![Jest progressbar tests](/img/posts/rewriting-transmission-ui-with-react/progressbar-test.png)
...
![Jest progressbar snapshots](/img/posts/rewriting-transmission-ui-with-react/progressbar-snapshot.png)
...
![A small React Transmission demo](/img/posts/rewriting-transmission-ui-with-react/react-transmission-demo.gif)
