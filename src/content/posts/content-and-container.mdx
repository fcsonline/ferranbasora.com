...
thumbnail: /img/posts/content-and-container/event-propagation.png
---

![Picture from Amazon.com](/img/posts/content-and-container/game-wood.png)
...
![A better approach for containers](/img/posts/content-and-container/new-cart-items.png)
...
components, and you can achieve that with `padding` and `gap` CSS rules.
...
![An event propagation example](/img/posts/content-and-container/event-propagation.png)
